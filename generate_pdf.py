...
def build_pdf(filename):
    ...
    c_rows = [
        ...
        ("Switzerland", "Zurich, Interlaken, Lake Brienz (Iseltwald), Sigriswil, Grindelwald", "4 Nights", "Swiss Alps Base (Zurich / Interlaken)"),
        ("Netherlands", "Amsterdam Canal Ring, Jordaan, Museumplein", "3 Nights", "Amsterdam Hostel Leidseplein"),
        ("Germany", "Cologne (Cathedral & Lindt Museum), Kehl", "2 Nights", "Hotel Innception (Cologne)\nB&B Hotel Kehl"),
        ("Overnight Sleeper", "FlixBus Inter-City Sleeper Routes", "4 Nights", "London➔AMS, AMS➔CGN, CGN➔Kehl, ZRH➔Paris, Paris➔LON")
    ]
    ...
    days = [
        ...
        ("Day 2<br/>16 Dec 2026", "Amsterdam<br/>(Netherlands)", "Arrival: Arrive Amsterdam Central Station at 10:25 am. Hotel check-in. Evening walking tour of the Amsterdam Light Festival along the UNESCO canal ring.", "Amsterdam Hostel Leidseplein<br/>(Leidseplein, Amsterdam)"),
        ("Day 3<br/>17 Dec 2026", "Amsterdam<br/>(Netherlands)", "Art & Ice: Morning cultural visit to the Rijksmuseum (Rembrandt, Vermeer). Afternoon enjoying the festive Ice Village Christmas Market at Museumplein.", "Amsterdam Hostel Leidseplein<br/>(Leidseplein, Amsterdam)"),
        ("Day 4<br/>18 Dec 2026", "Amsterdam<br/>(Netherlands)", "Canals: Daytime canal boat cruise through UNESCO canals. Stroll Jordaan and Nine Streets. Pack bags and transfer to Sloterdijk for midnight bus.", "Amsterdam Hostel Leidseplein<br/>(Night departure to Cologne)"),
        ("Day 5<br/>19 Dec 2026", "Cologne<br/>(Germany)", "Transit & Chocolate: FlixBus departs 12:45 am, arrives Cologne Airport 04:40 am. S-Bahn train into city center. Check into hotel. Visit Lindt Chocolate Museum.", "Hotel Innception<br/>(Hohenzollernring, Cologne)"),
        ("Day 6<br/>20 Dec 2026", "Cologne<br/>(Germany)", "Cathedral Market: Explore Cologne Cathedral (Kölner Dom), Cathedral Christmas Market, and Heinzels Wintermärchen Market in Cologne Old Town.", "Hotel Innception<br/>(Hohenzollernring, Cologne)"),
        ("Day 7<br/>21 Dec 2026", "Cologne ➔<br/>Kehl (Germany)", "Check-out by 12:00 pm. Afternoon exploration of Belgisches Viertel. Late-night transfer to Cologne Airport for 02:20 am overnight FlixBus to Kehl.", "Transit: FlixBus Overnight<br/>(Transfer via Frankfurt)"),
        ("Day 8<br/>22 Dec 2026", "Kehl & Strasbourg<br/>(Germany / France)", "Capital of Christmas: Arrive Kehl 09:15 am. Check into B&B Hotel. Cross-border tram into Strasbourg, France. Tour Place Kléber Great Tree & Christkindelsmärik.", "B&B Hotel Kehl<br/>(15 Allensteiner Str., Kehl)"),
        ...
        ("Day 10<br/>24 Dec 2026", "Kehl ➔ Zurich<br/>(Switzerland)", "Transit to Swiss Alps: Scenic train from Kehl to Zurich. Explore Lindenhof viewpoint and Münsterbrücke ('Crash Landing on You' opening locations).", "Swiss Alps Base<br/>(Zurich / Interlaken TBD)"),
        ("Day 11<br/>25 Dec 2026", "Lake Brienz<br/>(Switzerland)", "The Piano Scene: Christmas day trip to Iseltwald on Lake Brienz. Visit the exact lakeside piano landing stage from Crash Landing on You.", "Swiss Alps Base<br/>(Zurich / Interlaken TBD)"),
        ("Day 12<br/>26 Dec 2026", "Sigriswil<br/>(Switzerland)", "The Suspension Bridge: Day trip to Lake Thun and the spectacular Panoramabrücke Sigriswil suspension bridge with panoramic Alpine views.", "Swiss Alps Base<br/>(Zurich / Interlaken TBD)"),
        ("Day 13<br/>27 Dec 2026", "Grindelwald<br/>(Switzerland)", "The Reunion: Gondola up to First Flieger in Grindelwald (CLOY reunion scene). Enjoy the Cliff Walk and snow-capped mountain scenery.", "Swiss Alps Base<br/>(Zurich / Interlaken TBD)"),
        ("Day 14<br/>28 Dec 2026", "Zurich ➔ Paris<br/>(Switzerland / France)", "Departure: Final day strolling Lake Zurich and Bahnhofstrasse. Board the 09:00 pm overnight sleeper FlixBus direct to Paris Bercy Seine.", "Transit: FlixBus Overnight<br/>(Zurich to Paris Bercy)"),
