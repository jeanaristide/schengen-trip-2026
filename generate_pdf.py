...
def build_pdf(filename):
    ...
    c_rows = [
        ...
        ("Germany", "Frankfurt am Main (Base), Cologne & Düsseldorf Christmas Markets", "4 Nights", "Hotel Innception (Cologne) &\nPremier Inn Frankfurt City Centre"),
