...
def build_pdf(filename):
    ...
    days = [
        ("Day 1<br/>15 Dec 2026", "London ➔<br/>Amsterdam Central", "Confirmed FlixBus N824 (Ref: 338 890 0447): Departs London Victoria at 10:00 pm (Seats 11C/11D). Overnight Eurotunnel coach transit into Amsterdam Central at 10:25 am.", "Transit: FlixBus N824<br/>(Seats 11C & 11D Paid)"),
        ("Day 2<br/>16 Dec 2026", "Amsterdam<br/>(Netherlands)", "Arrival: Arrive Amsterdam Central (De Ruijterkade) at 10:25 am. Hotel luggage drop. Evening walking tour of the Amsterdam Light Festival along the UNESCO canal ring.", "Amsterdam Hostel Leidseplein<br/>(Night 1 of 2)"),
        ("Day 3<br/>17 Dec 2026", "Amsterdam &<br/>Zaanse Schans (NL)", "Windmills & Art: Morning train to Zaanse Schans for historic windmills and cheese farm. Afternoon Rijksmuseum masterpieces, Ice Village Christmas Market, and Dam Square.", "Amsterdam Hostel Leidseplein<br/>(Night 2 of 2)"),
        ("Day 4<br/>18 Dec 2026", "The Hague (NL) ➔<br/>Overnight Coach", "Justice & Temple: 48-min NS train to Den Haag. Photos at ICC & Peace Palace. Afternoon sacred Temple Endowment Session at The Hague Netherlands Temple in Zoetermeer. 12:45 am coach to Frankfurt.", "Transit: FlixBus Overnight<br/>(Departs 12:45 am, 19 Dec)"),
        ...
        ("Day 8<br/>22 Dec 2026", "Frankfurt am Main<br/>(Germany)", "Frankfurt & Taunus: Additional day in Frankfurt region for scheduled temple sessions, Taunus foothills exploration, and final German Christmas markets.", "Hotel Cristall<br/>(Night 4, Frankfurt)"),
        ("Day 9<br/>23 Dec 2026", "Frankfurt ➔<br/>Strasbourg (FR)", "Confirmed FlixBus N13 (Ref: 339 153 0857): Departs Frankfurt Hbf 04:35 am (Seats 3A/3B), arrives Strasbourg 08:35 am. Place Kléber 30m Great Tree, Christkindelsmärik, Petite France, Strasbourg Cathedral.", "B&B Hotel Kehl<br/>(Base for Alsace · Night 1 of 2)"),
        ("Day 10<br/>24 Dec 2026", "Colmar & Alsace<br/>(France)", "Fairytale Alsace Christmas Eve: 30-min TER train excursion along Alsatian Wine Route to Colmar. Petite Venise canals, Renaissance Maison Pfister, Christmas Eve in Alsace.", "B&B Hotel Kehl<br/>(Base for Alsace · Night 2 of 2)"),
        ("Day 11<br/>25 Dec 2026", "Strasbourg ➔<br/>Luzern ➔ Interlaken", "Confirmed FlixBus N846 (Ref: 339 152 8020): Departs Strasbourg 04:05 am (Seats 11C/11D), arrives Luzern at 07:10 am Christmas Morning! Kapellbrücke, Lion Monument. Scenic Zentralbahn train over Brünig Pass to Interlaken.", "Swiss Alps Base<br/>(Central Interlaken · Night 1 of 3)"),
        ("Day 12<br/>26 Dec 2026", "Lauterbrunnen &<br/>Mürren (CH)", "Valley of 72 Waterfalls: Scenic train to Lauterbrunnen (Staubbach Falls). Cable car & mountain railway up to car-free alpine village of Mürren with Eiger, Mönch & Jungfrau vistas.", "Swiss Alps Base<br/>(Central Interlaken · Night 2 of 3)"),
        ...
        ("Day 16<br/>30 Dec 2026", "Paris<br/>(France - Main)", "Art & Windows: Morning cultural tour of the Louvre Museum (Mona Lisa). Afternoon at Galeries Lafayette to view holiday window displays & glass dome.", "Break & Home Paris Italie<br/>(Porte de Choisy, Paris)"),
        ("Day 17<br/>31 Dec 2026", "Paris (NYE)<br/>(France - Main)", "New Year's Eve: Visit Eiffel Tower & Trocadéro. Evening Arc de Triomphe projection show and midnight fireworks celebration on the illuminated Champs-Élysées.", "Break & Home Paris Italie<br/>(Porte de Choisy, Paris)"),
        ("Day 18<br/>01 Jan 2027", "Paris<br/>(France - Main)", "New Year's Day: Relaxed morning stroll through Luxembourg Gardens, Latin Quarter, Île de la Cité, and Notre-Dame Cathedral perimeter.", "Break & Home Paris Italie<br/>(Porte de Choisy, Paris)"),
        ...
        ("Day 20<br/>03 Jan 2027", "Paris ➔ London<br/>(Exit Schengen)", "Confirmed FlixBus 1700 (Ref: 338 920 9866): Check out, souvenir shopping, Pont Alexandre III. Board 11:00 pm FlixBus at Paris Bercy Seine direct to London Victoria.", "Transit: FlixBus Route 1700<br/>(AUD $169.98 Paid)"),
